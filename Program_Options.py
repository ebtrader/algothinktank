...
class TestApp(TestWrapper, TestClient):
    ...
    def optionsOperations_req(self):
        ...
        self.calculateImpliedVolatility(5001, ContractSamples.USOptionContract(), 4.25, 170, []) # option price and underlying
        # ! [calculateimpliedvolatility]

        # Calculating option's price
        # ! [calculateoptionprice]
        self.calculateOptionPrice(5002, ContractSamples.USOptionContract(), .625, 170, []) #implied vol and underlying
        # ! [calculateoptionprice]
