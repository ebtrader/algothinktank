...
def next_weekday(weekday): # 0=Mon, 1=Tues, 2=Wed, 3=Thu, 4=Fri
    d = date.today()
...
next_monday = next_weekday(4)  # 0=Mon, 1=Tues, 2=Wed, 3=Thu, 4=Fri
...
print(month)
print(day)
converted_date = str(year) + str(month) + str(day)
