...
class TestApp(EWrapper, EClient):
    ...
    def start(self):
        ...
        # define trigger time on coming Monday and fire stock trade
        # pause.until(datetime(year, month, day, 18, 31, 0))  # this is the time at which you can buy shares

        # define trigger time on coming Monday and fire option trade
        print("Start now")
        pause.until(datetime(year, month, day, 4, 48, 0))
